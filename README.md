...
### 2. Khác nhau
- Cấu trúc dữ liệu: MongoDB là một hệ quản trị cơ sở dữ liệu NoSQL, sử dụng mô hình dữ liệu linh hoạt với tài liệu JSON/BSON. PostgreSQL và Percona Server là các hệ quản trị cơ sở dữ liệu SQL truyền thống, với cấu trúc dữ liệu bảng và quan hệ giữa các bảng.
- Tính linh hoạt: MongoDB cho phép lưu trữ dữ liệu có cấu trúc và không cấu trúc một cách tự nhiên, trong khi PostgreSQL và Percona Server có cấu trúc cố định dựa trên các bảng và quan hệ.
